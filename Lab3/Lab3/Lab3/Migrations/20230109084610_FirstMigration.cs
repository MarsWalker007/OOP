        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScenaristId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Films_Scenarists_ScenaristId",
                        column: x => x.ScenaristId,
                        principalTable: "Scenarists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Films_Types_TypeId",
                        column: x => x.TypeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Films_ScenaristId",
                table: "Films",
                column: "ScenaristId");

            migrationBuilder.CreateIndex(
                name: "IX_Films_TypeId",
                table: "Films",
                column: "TypeId");
        }
